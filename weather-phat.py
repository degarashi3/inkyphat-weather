...
draw.line((59, 36, 59, 83))       # Vertical line
draw.line((21, 35, 240, 35))      # Horizontal top line
draw.line((59, 58, 240, 58))      # Horizontal middle line
draw.line((21, 83, 240, 83))      # Horizontal bottom line
# draw.line((169, 58, 169, 58), 2)  # Red seaweed pixel :D

# Write text with weather values to the canvas
datetime = time.strftime("%Y/%m/%d %a")

draw.text((26, 12), datetime, inky_display.WHITE, font=font)
...
draw.text((62, 34), "T: " + u"{}°C".format(temperature) + "  H: " +  u"{}%".format(humidity), inky_display.WHITE, font=font)

# draw.text((72, 58), "CO2", inky_display.WHITE, font=font)
# draw.text((122, 58), u"{}ppm".format(co2), inky_display.WHITE, font=font)
draw.text((62, 58), "CO2: " + u"{}ppm".format(co2), inky_display.WHITE, font=font)

# Draw the current weather icon over the backdrop
if weather_icon is not None:
    img.paste(icons[weather_icon], (18, 36), masks[weather_icon])

else:
    draw.text((18, 36), "?", inky_display.RED, font=font)
